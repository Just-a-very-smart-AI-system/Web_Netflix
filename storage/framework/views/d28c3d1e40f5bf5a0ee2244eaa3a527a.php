...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('images/favicon_package/apple-touch-icon.png')); ?>">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.5.3/dist/css/bootstrap.min.css"
        integrity="sha384-TX8t27EcRE3e/ihU7zmQxVncDAy5uIKz4rEkgIXeMed4M0jlfIDPvg6uqKI2xXr2" crossorigin="anonymous">
    <link rel="stylesheet" href="<?php echo e(asset('css/Log_in.css')); ?>">
    <link rel="stylesheet" href="https://rsms.me/inter/inter.css">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/flowbite/1.8.0/flowbite.min.css" rel="stylesheet">
    <script src="<?php echo e(asset('js/log_in.js')); ?>" defer></script>
    <title>Netflax</title>
</head>
...
<body>
    <div class="main">
        <nav>
            <span><img width="180" src="<?php echo e(asset('images/logo.svg')); ?>" alt=""></span>
            <div>
        ...
        <div class="box"></div>
        <div class="hero" style="background-image: url('<?php echo e(asset('images/bg_img.jpg')); ?>');">
    ...
    <section class="first">
        ...
        <div class="sec-img">
            <img src="<?php echo e(asset('images/tv.jpg')); ?>" alt="">
            <video src="<?php echo e(asset('images/video2.m4v')); ?>" autoplay loop muted></video>
        </div>
    </section>
    ...
    <section class="first third">
        ...
        <div class="sec-img3">
            ...
            <video src="<?php echo e(asset('images/video1.m4v')); ?>" autoplay loop muted></video>
        </div>
    </section>
...
<?php /**PATH C:\Users\Admin\Desktop\Web_Netflax\Netflax\resources\views/log_in.blade.php ENDPATH**/ ?>